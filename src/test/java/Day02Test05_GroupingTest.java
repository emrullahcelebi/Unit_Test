...
public class Day02Test05_GroupingTest {
    ...
    @Nested
            // Math classının  multiplyExact() metodunu , sıfırlı veya sıfırsız
            // parametreler ile test etmek için yazdığım 2 test metodunu @Nested
            //annotation ile grupluyorum
    class MultiplyTest {
        @ParameterizedTest
    ...
    // 1.grup testin sonu
    @Nested
            // Math classının  addExact() metodunu , sıfırlı veya sıfırsız
            // parametreler ile test etmek için yazdığım 2 test metodunu @Nested
            //annotation ile grupluyorum
    class AddTest {
        @ParameterizedTest
